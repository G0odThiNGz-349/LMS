...
def list_students(page: int = Query(1, ge=1), page_size: int = Query(10, ge=1, le=10000), db: Session = Depends(get_db)
):
...
def list_enrollments(page: int = Query(1, ge=1), page_size: int = Query(10, ge=1, le=10000), db: Session = Depends(get_db)):
...
def list_attendance(page: int = Query(1, ge=1), page_size: int = Query(10, ge=1, le=10000), db: Session = Depends(get_db)):
...
def list_course_offerings(page: int = Query(1, ge=1), page_size: int = Query(10, ge=1, le=10000), db: Session = Depends(get_db)):
...
def list_courses(page: int = Query(1, ge=1), page_size: int = Query(10, ge=1, le=10000), db: Session = Depends(get_db)):
...
def list_departments(page: int = Query(1, ge=1), page_size: int = Query(10, ge=1, le=10000), db: Session = Depends(get_db)):
...
def list_academic_semester(page: int = Query(1, ge=1), page_size: int = Query(10, ge=1, le=10000), db: Session = Depends(get_db)):
...
def list_tickets(page: int = Query(1, ge=1), page_size: int = Query(10, ge=1, le=10000), db: Session = Depends(get_db)):
